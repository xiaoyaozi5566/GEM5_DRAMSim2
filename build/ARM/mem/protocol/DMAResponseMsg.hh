...
class DMAResponseMsg :  public NetworkMessage
{
  public:
    ...
    DMAResponseMsg(const DMAResponseType& local_Type, const Address& local_PhysicalAddress, const Address& local_LineAddress, const NetDest& local_Destination, const DataBlock& local_DataBlk, const MessageSizeType& local_MessageSize)
        : NetworkMessage()
    {
        m_Type = local_Type;
    ...
    static DMAResponseMsg*
    create()
    {
        return new DMAResponseMsg();
    }
