...
class DMARequestMsg :  public NetworkMessage
{
  public:
    ...
    DMARequestMsg(const DMARequestType& local_Type, const Address& local_PhysicalAddress, const Address& local_LineAddress, const MachineID& local_Requestor, const NetDest& local_Destination, const DataBlock& local_DataBlk, const int& local_Len, const MessageSizeType& local_MessageSize)
        : NetworkMessage()
    {
        m_Type = local_Type;
    ...
    static DMARequestMsg*
    create()
    {
        return new DMARequestMsg();
    }
