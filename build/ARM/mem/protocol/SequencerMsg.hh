...
class SequencerMsg :  public Message
{
  public:
    ...
    SequencerMsg(const Address& local_LineAddress, const Address& local_PhysicalAddress, const SequencerRequestType& local_Type, const Address& local_ProgramCounter, const RubyAccessMode& local_AccessMode, const DataBlock& local_DataBlk, const int& local_Len, const PrefetchBit& local_Prefetch)
        : Message()
    {
