// Auto generated C++ code started by /Users/yaowang/Desktop/GitHub/GEM5_DRAMSim2/src/mem/slicc/symbols/StateMachine.py:1102
...
Directory_State state = getState(m_tbe_ptr, addr);
    ...
    DPRINTF(RubyGenerated, "%s, Time: %lld, state: %s, event: %s, addr: %s\n",
            *this, g_system_ptr->getTime(), Directory_State_to_string(state),
